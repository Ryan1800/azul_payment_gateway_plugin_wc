 ...
 * Plugin URI: https://smartsoft.do/
 * Description: WooCommerce Plugin for accepting payment through Azul Payment Gateway (POST).
 * Version: 2.0.0
 * Author: smartsoft.do
 * Author URI: https://smartsoft.do
 * Contributors: SS TECHNOLOGY SMARTSOFTTECH
 * Requires at least: 4.0
 * Tested up to: 4.9.*
 *
 * Text Domain: azul-paymentgateway-plugin-wc
 * Domain Path: /lang/
 *
 * @package WC Azul Payment Gateway
 * @author SS TECHNOLOGY SMARTSOFTTECH
 */
...
function init_wc_gateway_azul()
{
    ...
    load_plugin_textdomain('azul-paymentgateway-plugin-wc', false, dirname(plugin_basename(__FILE__)) . '/lang');
    ...
    class wc_gateway_azul extends WC_Payment_Gateway
    {
        public function __construct()
        {
            ...
            $this->method_title = __('Azul Payments', 'azul-paymentgateway-plugin-wc');
        ...
        {
            ?>
	    	<h3><?php _e('Azul Payment Gateway by smartsoft.do', 'azul-paymentgateway-plugin-wc'); ?></h3>
	    	<p><?php _e('Azul Payment Gateway works by redirecting the buyer to Azul Payment page.
				...
				(adding a note to the order with the Aprobation Number and the masked credit card used in the transacction).', 'azul-paymentgateway-plugin-wc'); ?></p>
        ...
        Store Currency:' . get_woocommerce_currency() . '
				...
				<div style="float:right;text-align:right;">
					Made with &hearts; at <a href="https://smartsoft.do?ref=azul-paymentgateway-plugin-wc" target="_blank">smartsoft.do</a> | ¿Need help or custom integrations? <a href="https://smartsoft.do?ref=azul-paymentgateway-plugin-wc" target="_blank">Contact Us</a><br><br>
					<a href="https://smartsoft.do?ref=azul-paymentgateway-plugin-wc" target="_blank"><img src="' . plugins_url('images/ss_tech_logo.jpg', __FILE__) . '">
					</a>
				</div>', 'azul-paymentgateway-plugin-wc'); ?></p>
	    	<?php
        } // End admin_options()
        ...
        public function init_form_fields()
        {
            $this->form_fields = array(
                    'enabled' => array(
                        'title' => __('Enable/Disable', 'azul-paymentgateway-plugin-wc'),
                        'type' => 'checkbox',
                        'label' => __('Enable Azul Payments', 'azul-paymentgateway-plugin-wc'),
                        'default' => 'yes'
                    ),
                    'mode' => array(
                        'title' => __('Mode', 'azul-paymentgateway-plugin-wc'),
                        'type' => 'select',
                        'options' => array(
                            'test' => 'Test / Sandbox',
                            'live' => 'Live / Production'
                        ),
                        'description' => __('Select Test or Live mode.', 'azul-paymentgateway-plugin-wc'),
                        'default' => 'test'
                    ),
                    'title' => array(
                        'title' => __('Title', 'azul-paymentgateway-plugin-wc'),
                        'type' => 'text',
                        'description' => __('This controls the title which the user sees during checkout.', 'azul-paymentgateway-plugin-wc'),
                        'default' => __('Azul Payments', 'azul-paymentgateway-plugin-wc')
                    ),
                    'description' => array(
                        'title' => __('Description', 'azul-paymentgateway-plugin-wc'),
                        'type' => 'textarea',
                        'description' => __('This controls the description which the user sees during checkout.', 'azul-paymentgateway-plugin-wc'),
                        'default' => __("Pay with your Credit Card vía Azul payment page.", 'azul-paymentgateway-plugin-wc')
                    ),
                    'redirecting_message' => array(
                        'title' => __('Redirecting Message', 'azul-paymentgateway-plugin-wc'),
                        'type' => 'textarea',
                        'description' => __('Message displayed once the buyer finish the order and is redirected to Azul.', 'azul-paymentgateway-plugin-wc'),
                        'default' => __("Thank you for your order. We are now redirecting to Azul Payment Page to finish your order.", 'azul-paymentgateway-plugin-wc')
                    ),
                    'merchant_name' => array(
                        'title' => __('Merchant Name', 'azul-paymentgateway-plugin-wc'),
                        'type' => 'text',
                        'description' => __('Please enter your Merchant Name provided by Azul.', 'azul-paymentgateway-plugin-wc'),
                        'default' => ''
                    ),
                    'merchant_id' => array(
                        'title' => __('MerchantId', 'azul-paymentgateway-plugin-wc'),
                        'type' => 'text',
                        'description' => __('Please enter your MerchantId provided by Azul.', 'azul-paymentgateway-plugin-wc'),
                        'default' => ''
                    ),
                    'private_key' => array(
                        'title' => __('Private Key', 'azul-paymentgateway-plugin-wc'),
                        'type' => 'textarea',
                        'description' => __('Please enter your PrivateKey provided by Azul.', 'azul-paymentgateway-plugin-wc'),
                        'default' => ''
                    ),
                    'cancel_url' => array(
                        'title' => __('Cancel URL', 'azul-paymentgateway-plugin-wc'),
                        'type' => 'text',
                        'description' => __('The URL to redirect if the user cancel the payment at azul payment page.', 'azul-paymentgateway-plugin-wc'),
                        'default' => home_url('/my-account/orders/')
                    ),
                    'tax_percentage' => array(
                        'title' => __('Tax Percentage', 'azul-paymentgateway-plugin-wc'),
                        'type' => 'text',
                        'description' => __('The percentage to calculate the tax of the order total. Example: 0.18', 'azul-paymentgateway-plugin-wc'),
                        'default' => '0.18'
                    ),
                    'fallback_currency_multiplier' => array(
                        'title' => __('Default exchange Rate', 'azul-paymentgateway-plugin-wc'),
                        'type' => 'text',
                        'description' => __('If the currency exchange API doesn\'t work, multiply the order amount by this value.', 'azul-paymentgateway-plugin-wc'),
                        'default' => '48.5'
                    )
                );
        ...
        public function generate_azul_form($order_id)
        {
            ...
            return  '<form action="'.esc_url($gateway_url).'" method="post" id="azul_payment_form">
					...
					<input type="submit" class="button" id="submit_azul_payment_form" value="'.__('Pay Now', 'azul-paymentgateway-plugin-wc').'" /> <a class="button cancel" href="'.esc_url($order->get_cancel_order_url()).'">'.__('Cancel order &amp; restore cart', 'azul-paymentgateway-plugin-wc').'</a>
				</form>';
        }
        ...
        {
            echo '<p>'.__('Thank you for your order, please click the button below to pay with Azul Payments.', 'azul-paymentgateway-plugin-wc').'</p>';
        ...
        public function successful_request()
        {
            ...
            if ($localHash == $_GET['AuthHash']) {
                if ($params['IsoCode'] === '00') {
                    ...
                    $order->add_order_note(sprintf(__('Azul Payment Successful. The Aprobation Number is %s. Credit Card: %s', 'azul-paymentgateway-plugin-wc'), $params['AuthorizationCode'], $_GET['CardNumber']));
            ...
            wc_add_notice(sprintf(__('Transaction Failed. The Error Message was %s', 'azul-paymentgateway-plugin-wc'), $params['ResponseMessage']), $notice_type = 'error');
